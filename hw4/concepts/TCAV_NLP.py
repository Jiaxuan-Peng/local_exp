...
train, _ = torchtext.legacy.datasets.IMDB.splits(text_field=TEXT,
                                              label_field=Label,
                                              train='train',
                                              test='test',
                                              path='data/aclImdb')
...
loaded_vectors = torchtext.vocab.GloVe(name='6B', dim=50)
...
def get_tensor_from_filename(filename):
    ds = torchtext.legacy.data.TabularDataset(path=filename,
                                       fields=[('text', torchtext.legacy.data.Field()),
...
def assemble_concept(name, id, concepts_path="/home/u1413911/local_exp/hw4"):
...
neutral_concept = assemble_concept('neutral', 0, concepts_path="/home/u1413911/local_exp/hw4/neutral.csv")
positive_concept = assemble_concept('positive-adjectives', 5, concepts_path="/home/u1413911/local_exp/hw4/positive-adjectives.csv")
...
model = torch.load('/home/u1413911/local_exp/hw4/imdb-model-cnn-large.pt')
model.eval()
...
neutral_concept = assemble_concept('neutral', 0, concepts_path="/home/u1413911/local_exp/hw4/neutral.csv")
neutral_concept2 = assemble_concept('neutral2', 1, concepts_path="/home/u1413911/local_exp/hw4/neutral2.csv")
neutral_concept3 = assemble_concept('neutral3', 2, concepts_path="/home/u1413911/local_exp/hw4/neutral3.csv")
neutral_concept4 = assemble_concept('neutral4', 3, concepts_path="/home/u1413911/local_exp/hw4/neutral4.csv")
neutral_concept5 = assemble_concept('neutral5', 4, concepts_path="/home/u1413911/local_exp/hw4/neutral5.csv")
