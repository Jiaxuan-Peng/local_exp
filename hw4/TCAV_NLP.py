...
neutral_concept = assemble_concept('neutral', 0, concepts_path="neutral.csv")
positive_concept = assemble_concept('positive-adjectives', 5, concepts_path="positive-adjectives.csv")
...
#https://github.com/pytorch/captum/tree/master/tutorials/data/tcav/text-sensitivity
neutral_concept = assemble_concept('neutral', 0, concepts_path="neutral.csv")
neutral_concept2 = assemble_concept('neutral2', 1, concepts_path="neutral2.csv")
neutral_concept3 = assemble_concept('neutral3', 2, concepts_path="neutral3.csv")
neutral_concept4 = assemble_concept('neutral4', 3, concepts_path="neutral4.csv")
neutral_concept5 = assemble_concept('neutral5', 4, concepts_path="neutral5.csv")
